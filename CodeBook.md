...
##Code Book
```This code book summarizes the result data fields in tidy.txt```

###Identifiers
1. subject - ```The ID of the test subject``` <br>
2. activity - ```The type of activity performed when the corresponding measurements were taken``` <br>
